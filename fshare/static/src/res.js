...
/***/ function(module, exports, __webpack_require__) {
	...
	var res_core = function(root, init) {
    var q = init('Authorization', '/api');
    
    var r = root.shared = {};
        r.get_list = q('/shared/list', 'GET');
        r.post = q('/shared', 'POST');
        r.get_server_address = q('/shared/server_address', 'GET');
        r.delete = q('/shared', 'DELETE');
